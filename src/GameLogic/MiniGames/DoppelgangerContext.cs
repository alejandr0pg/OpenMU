...
/// <summary>
/// The context of a doppelganger game.
/// </summary>
/// <remarks>
/// Doppelganger is a wave-based PvE event:
///   Players enter via NPC Lugard and fight waves of monsters.
///   Monsters progressively get harder in each wave.
///   Players earn score by killing monsters (score = monster level).
///   Duration is typically 20 minutes with 4 difficulty levels.
///   Rewards are experience and money based on ranking.
/// </remarks>
public sealed class DoppelgangerContext : MiniGameContext
{
    ...
    public DoppelgangerContext(MiniGameMapKey key, MiniGameDefinition definition, IGameContext gameContext, IMapInitializer mapInitializer)
